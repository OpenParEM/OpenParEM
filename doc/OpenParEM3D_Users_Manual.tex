...
\begin{longtable}[c]{|lccp{8cm}|}
    ...
    gui.brep.file                 & string &        & Only used for the GUI OpenParEMg. File name of the the layout brep file. \\
    gui.slot.count               & int    & 5      & Number of slots to use when running OpenParEM3D.  Used on mpirun as mpirun -np gui.slot.count \\
