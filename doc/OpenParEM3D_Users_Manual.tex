...
The execution output from OpenParEM3D is captured to a log file with the name \texttt{projectname.log}.  For longer runs, it is very useful to watch the output as it is being generated, and this can be done by opening another terminal in the and running
\begin{Verbatim}[fontsize=\small]
   $ tail -f projectname.proj
\end{Verbatim}
