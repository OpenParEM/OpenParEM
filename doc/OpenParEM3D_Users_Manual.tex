...
\begin{longtable}[c]{|lccp{8cm}|}
    ...
    gui.physical.group            & int, int, string & Only used for the GUI OpenParEMg.  Provides the material name for a solid in the Brep model.  The three inputs are dim,tag,material_name \\
