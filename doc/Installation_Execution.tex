...
OpenParEM can be compiled for Linux-based operating systems and does not require administrator priviledges if the needed build tools make, g++, gfortran, perl, and tcl/tk are already installed.  If cloning the project from GitHub, then autoconf is also required.
