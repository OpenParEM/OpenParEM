...
A simple macro language is defined to enable stress and regression testing.  The stress and regression tests can be found in \texttt{regression/OpenParEMg}. Given its limited scope, the language is not fully developed and has limited error detection and messages. Any system implementing full automation of OpenParEM3D is expected to use a full-featured programming language to write the necessary text files to develop a complete project.
