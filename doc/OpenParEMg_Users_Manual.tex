...
# Set the drawing plane with the origin at (x0,y0,z0), the u-direction (ux,uy,uz), and the normal (nx,ny,nz)
...
# line is drawn from (x0,y0,z0) to (x1,y1,z1) on the drawing plane.  Points must be legal for the drawing plane.
drawLine name x0 y0 z0 x1 y1 z1

# polyline is drawn for the given N points on the drawing plane.  Points must be legal for the drawing plane.
# The polyline is closed if x0=xN, y0=yN, z0=zN
drawPolyine name N x0 y0 z0 x1 y1 z1 ... xN yN zN

# rectangle is drawn from (x0,y0,z0) to (x1,y1,z1) on the drawing plane.  Points must be legal for the drawing plane.
drawRectangle name x0 y0 z0 x1 y1 z1

# circle with center at (x0,y0,z0), first point at (x1,y1,z1).  Points must be legal for the drawing plane.
drawCircle name x0 y0 z0 x1 y1 z1 
...
# Delete the objects and promote the children.
deleteSelectedObjects

# Delete the object and its children.
deleteSubtreeSelectedObjects

# Extrude the selected objects by the given length and then re-name it to the given name.
extrudeSelectedObjects name length

# Merge the selected objects an then re-name the result to the given name.  Works only with two selected objects.
mergeSelectedObjects name

# Subtract the selected objects an then re-name the result to the given name.  Works only with two selected objects.
# Subtracts the second selected object from the first.
...
# Rotate the objects about the axis given by (x0,y0,z0) to (x1,y1,z1) by the given angle in degrees.
...
# drawing lines and polylines must be within the port outline
