...
void OpenParEMg::finishDeletePoint (BaseItem *item)
{
    if (!item) return;
...
void OpenParEMg::finishInsertPoint (BaseItem *item)
{
    if (!item) return;
    item->finishInsertPoint();
}

void OpenParEMg::finishStretchPoint (BaseItem *item)
{
